...
public class Bpmn2ChoreographyLoader {
    ...
    public Bpmn2ChoreographyLoader(final byte[] bpmnContent) throws ChoreographyArchitectureGeneratorException {
        this.documentRoot = ChoreographyArchitectureGeneratorUtils.getBpmn2DocumentRoot(bpmnContent);
        ...
        if (choreographies.isEmpty()) {
            throw new ChoreographyArchitectureGeneratorException("None choreography founded in the BPMN model");
        }
    ...
    public Choreography getChoreography(final SubChoreography subChoreography)
