...
public class ChoreographySpecificationGeneratorRequest implements java.io.Serializable {
    private static final long serialVersionUID = 7046992133958679760L;

    private byte[] choreographyArchitectureContent;

    public ChoreographySpecificationGeneratorRequest() {
    }
    
    public ChoreographySpecificationGeneratorRequest(byte[] choreographyArchitectureContent) {
        super();
