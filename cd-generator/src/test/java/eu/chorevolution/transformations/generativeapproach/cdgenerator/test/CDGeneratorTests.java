...
public class CDGeneratorTests {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CDGeneratorTests.class);	
	...
	@Test
	public void cdGenerator_01() {
		
		String cdParticipantName = "STApp";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP5_CD-STApp" + File.separatorChar 
				+CHOREOGRAPHIES_FOLDER_NAME;
		...
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-STApp").getAbsolutePath().replace(File
				.separatorChar+".","")+File.separatorChar+cdName+TARGZ_EXTENSION;		
		...
		try {
			...
			String clientBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar
					+ "CD-STApp" + File.separatorChar + "CD-STApp.bpmn2").getAbsolutePath();
			...
			for (String prosumerParticipantName : prosumersParticipantsNames) {
				...
				if(prosumerParticipantName.equals("Tourist Agent")){
					participantBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
							+ "CD-TouristAgent" +File.separatorChar + "CD-TouristAgent.bpmn2")
							.getAbsolutePath();
				...
				if(prosumerParticipantName.equals("Trip Planner")){
					participantBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
							+ "CD-TripPlanner" +File.separatorChar + "CD-TripPlanner.bpmn2")
							.getAbsolutePath();
					participantTypesFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
			...
			LOGGER.error("cdGenerator_01 > ",e);
			Assert.assertTrue(false);
		}
	}

	@Test
	public void cdGenerator_01_NoCorrelationTasks() {
		...
		try {
			...
			LOGGER.error("cdGenerator_01_NoCorrelationTasks > ",e);
			Assert.assertTrue(false);
		}
	}	
	
	@Test
	public void cdGenerator_02() {
		
		String cdParticipantName = "Tourist Agent";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP5_CD-TouristAgent" + File.separatorChar 
				+CHOREOGRAPHIES_FOLDER_NAME;
		...
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-TouristAgent").getAbsolutePath()
		...
		try {
			...
			WSDLData data = new WSDLData("Poi", FileUtils
			...
			LOGGER.error("cdGenerator_02 > ",e);
			Assert.assertTrue(false);
		}
	}
	
	@Test
	public void cdGenerator_03() {
		
		String cdParticipantName = "Trip Planner";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP5_CD-TripPlanner" + File.separatorChar 
				+CHOREOGRAPHIES_FOLDER_NAME;
		...
		String wsdlsFolderAbsolutePath = (new File(wsdlsFolder).getAbsolutePath())
				.replace(File.separatorChar+".","") + File.separatorChar;	
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-TripPlanner").getAbsolutePath()
				.replace(File.separatorChar+".","")+File.separatorChar+cdName+TARGZ_EXTENSION;		
		...
		try {
			...
			WSDLData data = new WSDLData("Traffic Information", FileUtils.readFileToByteArray(new File(
					wsdlsFolderAbsolutePath+"trafficinformation.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("Journey Planner", FileUtils.readFileToByteArray(new File(
	        		wsdlsFolderAbsolutePath+"journeyplanner.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("OSM Parking", FileUtils.readFileToByteArray(new File(
	        		wsdlsFolderAbsolutePath+"osmparking.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("Public Transportation", FileUtils.readFileToByteArray(new File(
	        		wsdlsFolderAbsolutePath+"publictransportation.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("Weather", FileUtils.readFileToByteArray(new File(
	        		wsdlsFolderAbsolutePath+"weather.wsdl")));
	        wsdlData.add(data); 
			...
			LOGGER.error("cdGenerator_03 > ",e);
			Assert.assertTrue(false);
		}
	}		
	
	@Test
	public void cdGenerator_04() {
		
		String cdParticipantName = "ND";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP4_SEADA_CD_ND" + File.separatorChar 
				+CHOREOGRAPHIES_FOLDER_NAME;
		...
		String typesFileAbsolutePath = new File(TEST_RESOURCES + "test_WP4_SEADA_CD_ND" + File.separatorChar 
				+CHOREOGRAPHY_FOLDER_NAME+ File.separatorChar + "types.xsd").getAbsolutePath();
		String targz = new File(TEST_RESOURCES + "test_WP4_SEADA_CD_ND").getAbsolutePath()
				.replace(File.separatorChar +".","")+File.separatorChar+cdName+TARGZ_EXTENSION;		
		...
		try {
			...
			String clientBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar + "CD-ND" 
					+File.separatorChar + "CD-ND.bpmn2").getAbsolutePath();
			...
			for (String prosumerParticipantName : prosumersParticipantsNames) {
				...
				if(prosumerParticipantName.equals("SEADA-SEARP")){
					participantBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
							+ "CD-SEADA-SEARP" +File.separatorChar + "CD-SEADA-SEARP.bpmn2")
							.getAbsolutePath();
					participantTypesFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
				...
				if(prosumerParticipantName.equals("SEADA-SEATSA")){
					participantBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
							+ "CD-SEADA-SEATSA" +File.separatorChar + "CD-SEADA-SEATSA.bpmn2")
							.getAbsolutePath();
					participantTypesFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
				...
				if(prosumerParticipantName.equals("SEADA-TRAFFIC")){
					participantBpmnFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
							+ "CD-SEADA-TRAFFIC" +File.separatorChar + "CD-SEADA-TRAFFIC.bpmn2")
							.getAbsolutePath();
					participantTypesFileAbsolutePath = new File(choreographiesFolder+ File.separatorChar 
			...
			LOGGER.error("cdGenerator_04 > ",e);
			Assert.assertTrue(false);
		}
	}
	
	@Test
	public void cdGenerator_05() {
		
		String cdParticipantName = "SEADA-SEARP";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP4_SEADA_CD_SEADA-SEARP"
		...
		String bpmnFileAbsolutePath = new File(TEST_RESOURCES + "test_WP4_SEADA_CD_SEADA-SEARP"
				+ File.separatorChar 
				+CHOREOGRAPHY_FOLDER_NAME+ File.separatorChar + "CD-SEADA-SEARP.bpmn2").getAbsolutePath();
		...
		try {
	        ...
	        data = new WSDLData("DTS-HERE", FileUtils
	        		.readFileToByteArray(new File(wsdlsFolderAbsolutePath+"DTS-HERE.wsdl")));
	        wsdlData.add(data);
			...
			LOGGER.error("cdGenerator_05 > ",e);
			Assert.assertTrue(false);
		}
	}	
	
	@Test
	public void cdGenerator_06() {
		
		String cdParticipantName = "SEADA-SEATSA";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP4_SEADA_CD_SEADA-SEATSA" + File.separatorChar 
				+CHOREOGRAPHIES_FOLDER_NAME;
		...
		try {
			...
			LOGGER.error("cdGenerator_06 > ",e);
			Assert.assertTrue(false);
		}
	}	
	
	@Test
	public void cdGenerator_07() {
		
		String cdParticipantName = "SEADA-TRAFFIC";		
		String cdName = Utils.createCDname(cdParticipantName);
		String choreographiesFolder = TEST_RESOURCES + "test_WP4_SEADA_CD_SEADA-TRAFFIC"
				+ File.separatorChar + CHOREOGRAPHIES_FOLDER_NAME;
