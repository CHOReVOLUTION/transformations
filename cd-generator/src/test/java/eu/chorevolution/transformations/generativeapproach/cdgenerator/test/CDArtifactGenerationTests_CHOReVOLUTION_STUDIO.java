...
public class CDArtifactGenerationTests_CHOReVOLUTION_STUDIO {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(CDArtifactGenerationTests_CHOReVOLUTION_STUDIO.class);
	...
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_01() {
		...
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-STApp_CHOReVOLUTION_STUDIO").getAbsolutePath()
				...
				.createCDname(cdClientParticipantName)+TARGZ_EXTENSION;		
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_01 > ",e);
			Assert.assertTrue(false);
		}	
	}

	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_01_NoCorrelationTasks() {
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_01_NoCorrelationTasks > ",e);
			Assert.assertTrue(false);
		}	
	}	
	
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_02() {
		...
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-TouristAgent_CHOReVOLUTION_STUDIO")
				.getAbsolutePath().replace(File.separatorChar+".","") + File.separatorChar + Utils
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_02 > ",e);
			Assert.assertTrue(false);
		}
	}
	
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_03() {
		...
		String targz = new File(TEST_RESOURCES + "test_WP5_CD-TripPlanner_CHOReVOLUTION_STUDIO")
				.getAbsolutePath().replace(File.separatorChar+".","") + File.separatorChar 
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_03 > ",e);
			Assert.assertTrue(false);
		}
	}	

	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_04() {
		...
		String typesFileAbsolutePath = new File(TEST_RESOURCES + "test_WP4_SEADA_CD_ND_CHOReVOLUTION_STUDIO" 
				+ File.separatorChar +CHOREOGRAPHY_FOLDER_NAME+ File.separatorChar + "types.xsd")
				.getAbsolutePath();
		String wsdlsFolder = TEST_RESOURCES+ "test_WP4_SEADA_CD_ND_CHOReVOLUTION_STUDIO" + File.separatorChar 
				+WSDLS_FOLDER_NAME; 
		String wsdlsFolderAbsolutePath = (new File(wsdlsFolder).getAbsolutePath())
				.replace(File.separatorChar+".","") + File.separatorChar;
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_04 > ",e);
			Assert.assertTrue(false);
		}	
	}
	
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_05() {
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_05 > ",e);
			Assert.assertTrue(false);
		}
	}	
	
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_06() {
		...
		try {
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_06 > ",e);
			Assert.assertTrue(false);
		}
	}
	
	@Test
	public void generateCDArtifact_CHOReVOLUTION_STUDIO_07() {
		...
		try {
	        ...
	        wsdlData.add(data);			
	        data = new WSDLData("DTS-BRIDGE", FileUtils.readFileToByteArray(new File(wsdlsFolderAbsolutePath
	        		+ "bcDTS-BRIDGE.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("DTS-CONGESTION", FileUtils
	        		.readFileToByteArray(new File(wsdlsFolderAbsolutePath+ "bcDTS-CONGESTION.wsdl")));
	        wsdlData.add(data);
	        data = new WSDLData("DTS-WEATHER", FileUtils.readFileToByteArray(new File(wsdlsFolderAbsolutePath
	        		+ "bcDTS-WEATHER.wsdl")));
	        wsdlData.add(data);	        
	        data = new WSDLData("SEADA-SEATSA", FileUtils
	        		.readFileToByteArray(new File(wsdlsFolderAbsolutePath + "cdSEADA-SEATSA.wsdl")));
			...
			LOGGER.error("generateCDArtifact_CHOReVOLUTION_STUDIO_07 > ",e);
			Assert.assertTrue(false);
		}
	}	
}
