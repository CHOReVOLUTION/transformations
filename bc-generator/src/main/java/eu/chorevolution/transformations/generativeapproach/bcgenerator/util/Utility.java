...
public class Utility {
	...
	public static void createZipOfDirectory(String directoryPath, String destination, String zipName) {
        ...
        try {
			...
			throw new BCGeneratorException("Exception into createZipfDirectory see log file for details ");
		}
	...
	public static byte[] createTarGzOfDirectory(String directoryPath, String destination, String tarGzName) {
		...
		try {
			...
			throw new BCGeneratorException("Exception into createTarGzOfDirectory see log file for details ");
		}
		return bytes;
	}
	...
	private static void addFileToTarGz(TarArchiveOutputStream tOut, String path, String base) {
		...
		try {
			...
			LOGGER.error(e.getMessage(), e);
			throw new BCGeneratorException("Exception into addFileToTarGz see log file for details ");
		}
	}
	...
	public static String createTemporaryFolderFromMillisAndGetPath() {
		...
		try {
			...
			LOGGER.error(e.getMessage(), e);
			throw new BCGeneratorException("Exception into createDestinationFolderAndGetPath see log file for details ");
		}
		return destDir;
	}
	...
	public static void createProjectFolders(String destinationRootPath) {
		...
		try {
			...
			LOGGER.error(e.getMessage(), e);
			throw new BCGeneratorException("Exception into createProjectFolders see log file for details ");
		}
	}
