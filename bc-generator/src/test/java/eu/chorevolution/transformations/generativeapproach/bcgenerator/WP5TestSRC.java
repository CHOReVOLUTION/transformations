...
public class WP5TestSRC {
	...
	public void generateJourneyPlanner() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + JOURNEY_PLANNER_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
	...
	public void generateNews() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + NEWS_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generateParking() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + PARKING_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generatePoi() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + POI_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generatePublicTransportation() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + PUBLICTRANSPORTATION_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generatePersonalWeatherStations() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + PWS_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generateTraffic() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + TRAFFIC_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
	...
	public void generateSTApp() {
		try {
			...
			Files.write(Paths.get(TEST_OUTPUT_RESOURCES + File.separatorChar + STAPP_NAME + TAR_GZ_EXTENSION),
					result.getArtifact());
			if (result.getWsdl() != null) {
