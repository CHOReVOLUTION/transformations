...
public class CDConsumerPartGeneratorWP4WithoutLoopTests {
	private static final Logger LOGGER = LoggerFactory.getLogger(CDConsumerPartGeneratorWP4WithoutLoopTests.class);
	...
	public void generateCDConsumerPart_02() {
		try {
			...
			String cdTempFolderPath = TEST_OUTPUT_RESOURCES + File.separatorChar + cdConsumerPartData.getName();
			String wsdlFileName = TEST_RESOURCES + File.separatorChar + "wp4" + File.separatorChar + "withoutloop" + File.separatorChar + "SEADA-SEATSA.wsdl";
			byte[] wsdl = FileUtils.readFileToByteArray(new File(wsdlFileName));
	...
	@Test
	public void generateCDConsumerPart_03() {
		try {
			CDConsumerPartData cdConsumerPartData = new CDConsumerPartData();
			...
			String cdTempFolderPath = TEST_OUTPUT_RESOURCES + File.separatorChar + cdConsumerPartData.getName();
			String wsdlFileName = TEST_RESOURCES + File.separatorChar + "wp4" + File.separatorChar + "withoutloop" + File.separatorChar + "SEADA-TRAFFIC.wsdl";
			byte[] wsdl = FileUtils.readFileToByteArray(new File(wsdlFileName));
