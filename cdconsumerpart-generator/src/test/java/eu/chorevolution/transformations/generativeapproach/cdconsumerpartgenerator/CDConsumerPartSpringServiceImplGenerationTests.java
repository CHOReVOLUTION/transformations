...
public class CDConsumerPartSpringServiceImplGenerationTests {
	...
	@Test
	public void generateSpringServiceImplCDConsumerPart_01() {
		...
		try {
			...
			CDConsumerPartGeneratorUtility.generateSpringServiceImpl(TEST_OUTPUT_RESOURCES, generatingJavaData);
	...
	@Test
	public void generateSpringServiceImplCDConsumerPart_02() {
		...
		try {
			...
			e.printStackTrace();
			LOGGER.error("generateSpringServiceImplCDConsumerPart_02 > ", e);
			Assert.assertTrue(false);
		}
	}

	@Test
	public void generateSpringServiceImplCDConsumerPart_03() {
		...
		try {
			...
			e.printStackTrace();
			LOGGER.error("generateSpringServiceImplCDConsumerPart_03 > ", e);
			Assert.assertTrue(false);
		}
	}	
}
